...
urlpatterns = patterns('',	
    ...
    url(r'^sort/match', 'profiles.views.sort_by_match', name="sort_by_match"),
    url(r'^sort/location', 'profiles.views.sort_by_location', name="sort_by_location"),
    ...
    url(r'^edit/pictures/delete/$', 'profiles.views.delete_picture', name='delete_picture'),
    ...
    url(r'^new_picture/$', 'profiles.views.new_picture1', name='new_picture'),
