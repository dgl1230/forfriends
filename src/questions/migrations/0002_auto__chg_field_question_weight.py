...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.weight'
        db.alter_column(u'questions_question', 'weight', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Question.weight'
        db.alter_column(u'questions_question', 'weight', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=2))
