...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.pattern_number'
        db.alter_column(u'questions_answer', 'pattern_number', self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Answer.pattern_number'
        db.alter_column(u'questions_answer', 'pattern_number', self.gf('django.db.models.fields.IntegerField')(null=True))
