...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAnswer.importance_level'
        db.alter_column(u'questions_useranswer', 'importance_level', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'UserAnswer.importance_level'
        db.alter_column(u'questions_useranswer', 'importance_level', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))
