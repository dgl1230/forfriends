...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.approved'
        db.add_column(u'questions_question', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.approved'
        db.delete_column(u'questions_question', 'approved')
