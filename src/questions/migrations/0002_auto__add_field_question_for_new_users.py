...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.for_new_users'
        db.add_column(u'questions_question', 'for_new_users',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.for_new_users'
        db.delete_column(u'questions_question', 'for_new_users')
