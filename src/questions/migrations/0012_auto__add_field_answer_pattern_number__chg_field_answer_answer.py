...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.pattern_number'
        db.add_column(u'questions_answer', 'pattern_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Answer.answer'
        db.alter_column(u'questions_answer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Answer.pattern_number'
        db.delete_column(u'questions_answer', 'pattern_number')


        # Changing field 'Answer.answer'
        db.alter_column(u'questions_answer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        u'questions.answer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pattern_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
