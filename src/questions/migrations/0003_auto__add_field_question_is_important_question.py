...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.is_important_question'
        db.add_column(u'questions_question', 'is_important_question',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.is_important_question'
        db.delete_column(u'questions_question', 'is_important_question')
    ...
    models = {
        ...
        u'questions.question': {
            ...
            'for_new_users': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_important_question': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
