...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MatchAnswer.importance_level'
        db.delete_column(u'questions_matchanswer', 'importance_level')


    def backwards(self, orm):
        # Adding field 'MatchAnswer.importance_level'
        db.add_column(u'questions_matchanswer', 'importance_level',
                      self.gf('django.db.models.fields.CharField')(default='Somewhat Important', max_length=20, null=True, blank=True),
                      keep_default=False)
