...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserInterestAnswer.points'
        db.delete_column(u'interests_userinterestanswer', 'points')


    def backwards(self, orm):
        # Adding field 'UserInterestAnswer.points'
        db.add_column(u'interests_userinterestanswer', 'points',
