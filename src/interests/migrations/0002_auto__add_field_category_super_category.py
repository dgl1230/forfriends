...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.super_category'
        db.add_column(u'interests_category', 'super_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interests.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.super_category'
        db.delete_column(u'interests_category', 'super_category_id')
