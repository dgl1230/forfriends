...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Interest.user'
        db.delete_column(u'interests_interest', 'user_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Interest.user'
        raise RuntimeError("Cannot reverse this migration. 'Interest.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Interest.user'
        db.add_column(u'interests_interest', 'user',
