...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interest.approved'
        db.add_column(u'interests_interest', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interest.approved'
        db.delete_column(u'interests_interest', 'approved')
