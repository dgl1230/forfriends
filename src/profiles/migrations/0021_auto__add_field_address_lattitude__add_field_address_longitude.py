...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.lattitude'
        db.add_column(u'profiles_address', 'lattitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Address.longitude'
        db.add_column(u'profiles_address', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.lattitude'
        db.delete_column(u'profiles_address', 'lattitude')

        # Deleting field 'Address.longitude'
        db.delete_column(u'profiles_address', 'longitude')
    ...
    models = {
        ...
        u'profiles.info': {
            ...
            'new_to_discover': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
