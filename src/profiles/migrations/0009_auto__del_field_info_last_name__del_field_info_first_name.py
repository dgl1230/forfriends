...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Info.last_name'
        db.delete_column(u'profiles_info', 'last_name')

        # Deleting field 'Info.first_name'
        db.delete_column(u'profiles_info', 'first_name')


    def backwards(self, orm):
        # Adding field 'Info.last_name'
        db.add_column(u'profiles_info', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Info.first_name'
        db.add_column(u'profiles_info', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)
