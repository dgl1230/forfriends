...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_address', 'zipcode', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Address.zipcode'
        raise RuntimeError("Cannot reverse this migration. 'Address.zipcode' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Address.zipcode'
        db.alter_column(u'profiles_address', 'zipcode', self.gf('django.db.models.fields.IntegerField')(max_length=5))
