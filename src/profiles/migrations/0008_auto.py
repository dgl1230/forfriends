...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field friends_list on 'Gamification'
        m2m_table_name = db.shorten_name(u'profiles_gamification_friends_list')
    ...
    def backwards(self, orm):
        # Removing M2M table for field friends_list on 'Gamification'
        db.delete_table(db.shorten_name(u'profiles_gamification_friends_list'))
    ...
    models = {
        ...
        u'profiles.gamification': {
            ...
            'friends_list': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'friends_list'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
