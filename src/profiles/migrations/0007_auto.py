...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field circle on 'Gamification'
        m2m_table_name = db.shorten_name(u'profiles_gamification_circle')
        ...
        db.create_unique(m2m_table_name, ['gamification_id', 'match_id'])


    def backwards(self, orm):
        # Removing M2M table for field circle on 'Gamification'
        db.delete_table(db.shorten_name(u'profiles_gamification_circle'))
