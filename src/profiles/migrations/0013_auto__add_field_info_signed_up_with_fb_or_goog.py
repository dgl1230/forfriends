...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Info.signed_up_with_fb_or_goog'
        db.add_column(u'profiles_info', 'signed_up_with_fb_or_goog',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Info.signed_up_with_fb_or_goog'
        db.delete_column(u'profiles_info', 'signed_up_with_fb_or_goog')
