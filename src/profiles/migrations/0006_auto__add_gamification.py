...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_gamification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('circle_reset_started', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('circle_time_until_reset', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('icebreaker_reset_started', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('icebreaker_until_reset', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('speed_friend_reset_started', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('speed_friend_until_reset', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'profiles', ['Gamification'])


    def backwards(self, orm):
        # Deleting model 'Gamification'
        db.delete_table(u'profiles_gamification')
