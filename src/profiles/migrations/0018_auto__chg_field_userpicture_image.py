...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPicture.image'
        db.alter_column(u'profiles_userpicture', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'UserPicture.image'
        db.alter_column(u'profiles_userpicture', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
