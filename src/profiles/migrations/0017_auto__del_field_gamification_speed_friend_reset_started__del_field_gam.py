...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Gamification.speed_friend_reset_started'
        db.delete_column(u'profiles_gamification', 'speed_friend_reset_started')

        # Deleting field 'Gamification.speed_friend_until_reset'
        db.delete_column(u'profiles_gamification', 'speed_friend_until_reset')

        # Deleting field 'Gamification.circle_reset_started'
        db.delete_column(u'profiles_gamification', 'circle_reset_started')

        # Deleting field 'Gamification.icebreaker_reset_started'
        db.delete_column(u'profiles_gamification', 'icebreaker_reset_started')


    def backwards(self, orm):
        # Adding field 'Gamification.speed_friend_reset_started'
        db.add_column(u'profiles_gamification', 'speed_friend_reset_started',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gamification.speed_friend_until_reset'
        db.add_column(u'profiles_gamification', 'speed_friend_until_reset',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gamification.circle_reset_started'
        db.add_column(u'profiles_gamification', 'circle_reset_started',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gamification.icebreaker_reset_started'
        db.add_column(u'profiles_gamification', 'icebreaker_reset_started',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'matches.match': {
            ...
            'are_friends': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'currently_in_icebreaker': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
