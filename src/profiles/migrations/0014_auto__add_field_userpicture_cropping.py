...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPicture.cropping'
        db.add_column(u'profiles_userpicture', 'cropping',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPicture.cropping'
        db.delete_column(u'profiles_userpicture', 'cropping')
