...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Info.new_to_discover'
        db.add_column(u'profiles_info', 'new_to_discover',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Info.new_to_discover'
        db.delete_column(u'profiles_info', 'new_to_discover')
