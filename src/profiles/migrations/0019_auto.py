...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field discover_list on 'Gamification'
        m2m_table_name = db.shorten_name(u'profiles_gamification_discover_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gamification', models.ForeignKey(orm[u'profiles.gamification'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['gamification_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field discover_list on 'Gamification'
        db.delete_table(db.shorten_name(u'profiles_gamification_discover_list'))
    ...
    models = {
        ...
        u'profiles.gamification': {
            ...
            'discover_list': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'discover_list'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
