...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.matched_approved'
        db.add_column(u'matches_match', 'matched_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.matched_approved'
        db.delete_column(u'matches_match', 'matched_approved')
    ...
    models = {
        ...
        u'matches.match': {
            ...
            'matched_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
