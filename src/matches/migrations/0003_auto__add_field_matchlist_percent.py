...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchList.percent'
        db.add_column(u'matches_matchlist', 'percent',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=10, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchList.percent'
        db.delete_column(u'matches_matchlist', 'percent')
    ...
    models = {
        ...
        u'matches.matchlist': {
            ...
            'read_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
