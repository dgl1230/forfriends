...
urlpatterns = patterns('directmessages.views',
    ...
    url(r'^sent/delete/$', 'delete_messages', name='delete_sent_messages'),
    url(r'^sent/delete_individual/(?P<dm_id>[\d]+)$', 'delete_individual_sent_message', name='delete_individual_sent_message'),
